...
//아이디, 비밀번호, 이름을 전달받고 일므의 기본값을 사용자로 설정하기 
//함수명 : introduce 매개변수o, 리턴값x
//출력문 1개만 작성

function introduce(id, pw, name="사용자"){
  console.log(`제 이름은 ${name}입니다. 아이디는 ${id}, 비밀번호는 ${pw} 입니다`);
}

introduce('qorwjddl', 0123, '정이');
//제 이름은 정이입니다. 아이디는 qorwjddl, 비밀번호는 83 입니다
// 0123 으로 인수를 전달하면 8진수로 해석되어 계산된다 
// 0123을 8진수로 변환 => 1 x 8^3 + 2 x 8^2 + 3 x 8^0 = 83(10진수)
