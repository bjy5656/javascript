...
// console.log(str1, typeof(str2), num2, typeof(num2));
...
console.log(Boolean(""), typeof Boolean("")); //빈문자열이므로 false
...
// true와 false는 boolean타입의 명확한 값으로 참과 거짓을 나타낸다 
...
// Object
// 객체 : 키-값 쌍의 집합
let person = {name : "백정이", age : 20, isStudent : true};
console.log(person, typeof person); //{ name: '백정이', age: 20, isStudent: true }

console.log(person.name, typeof person.name); //백정이 string 
